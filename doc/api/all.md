...
GET /api/v1/exam/question/detail/{id}
...
|名称|位置|类型|必选|说明|
|---|---|---|---|---|
|id|path|integer| 是 |想获取详情的题目的id|
|type|query|string| 是 |题目类型（主观题/判断题/...）|
...
GET /api/v1/exam/question/delete/{id}
...
|» specialty|body|string| 否 |none|
|» faculties|body|string| 否 |none|
